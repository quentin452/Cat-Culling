...
@Mod(
    modid = CatCullingBase.MODID,
    version = CatCullingBase.VERSION,
    name = CatCullingBase.NAME,
...
public class CatCullingBase extends EntityCullingBase {
    ...
    @Mod.Instance("catculling")
    public static CatCullingBase instance;
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        try {
            ...
            System.out.println("CatCullingBase Mod installed on a Server. Going to sleep.");
            onServer = true;
            return;
        }
        onInitialize();
