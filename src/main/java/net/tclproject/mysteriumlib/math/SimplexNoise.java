...
public class SimplexNoise {
    ...
    private static final Grad[] grad3 = new Grad[] { new Grad(1.0D, 1.0D, 0.0D), new Grad(-1.0D, 1.0D, 0.0D),
    ...
    private static final Grad[] grad4 = new Grad[] { new Grad(0.0D, 1.0D, 1.0D, 1.0D),
        new Grad(0.0D, 1.0D, 1.0D, -1.0D), new Grad(0.0D, 1.0D, -1.0D, 1.0D), new Grad(0.0D, 1.0D, -1.0D, -1.0D),
        new Grad(0.0D, -1.0D, 1.0D, 1.0D), new Grad(0.0D, -1.0D, 1.0D, -1.0D), new Grad(0.0D, -1.0D, -1.0D, 1.0D),
        new Grad(0.0D, -1.0D, -1.0D, -1.0D), new Grad(1.0D, 0.0D, 1.0D, 1.0D), new Grad(1.0D, 0.0D, 1.0D, -1.0D),
        ...
        new Grad(1.0D, -1.0D, 0.0D, -1.0D), new Grad(-1.0D, 1.0D, 0.0D, 1.0D), new Grad(-1.0D, 1.0D, 0.0D, -1.0D),
        new Grad(-1.0D, -1.0D, 0.0D, 1.0D), new Grad(-1.0D, -1.0D, 0.0D, -1.0D), new Grad(1.0D, 1.0D, 1.0D, 0.0D),
        new Grad(1.0D, 1.0D, -1.0D, 0.0D), new Grad(1.0D, -1.0D, 1.0D, 0.0D), new Grad(1.0D, -1.0D, -1.0D, 0.0D),
        new Grad(-1.0D, 1.0D, 1.0D, 0.0D), new Grad(-1.0D, 1.0D, -1.0D, 0.0D), new Grad(-1.0D, -1.0D, 1.0D, 0.0D),
        new Grad(-1.0D, -1.0D, -1.0D, 0.0D) };
