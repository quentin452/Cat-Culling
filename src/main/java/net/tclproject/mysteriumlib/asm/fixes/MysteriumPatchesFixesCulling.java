...
public class MysteriumPatchesFixesCulling {
    ...
    public static boolean func_147549_a(TileEntityRendererDispatcher tileEntityRendererDispatcher,
        TileEntity p_147549_1_, double p_147549_2_, double p_147549_4_, double p_147549_6_, float p_147549_8_) {
    ...
    @Fix(returnSetting = EnumReturnSetting.ON_TRUE)
    public static boolean func_147939_a(RenderManager rm, Entity entity, double p_doRenderEntity_2_, double d1,
        double d2, float tickDelta, float p_doRenderEntity_9_, boolean p_doRenderEntity_10_) {
    ...
    private static void renderNameTag(EntityLivingBase entity, double p_77033_2_, double p_77033_4_,
        double p_77033_6_) {
        float f = 1.6F;
        ...
        if (d3 < (double) (f2 * f2)) {
            ...
            if (entity.isSneaking()) {
                ...
                setupRenderForNametag(entity, (float) p_77033_2_, (float) p_77033_4_, (float) p_77033_6_, f1);
    ...
    protected static void func_96449_a(EntityLivingBase p_96449_1_, double p_96449_2_, double p_96449_4_,
    ...
    protected static void func_147906_a(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_,
        ...
        if (d3 <= (double) (p_147906_9_ * p_147906_9_)) {
            ...
            float f = 1.6F;
            float f1 = 0.016666668F * f;
            setupRenderForNametag(p_147906_1_, (float) p_147906_3_, (float) p_147906_5_, (float) p_147906_7_, f1);
            GL11.glDepthMask(false);
    ...
    private static void setupRenderForNametag(Entity p_147906_1_, float p_147906_3_, float p_147906_5_,
        float p_147906_7_, float f1) {
        GL11.glPushMatrix();
    ...
    @Fix(returnSetting = EnumReturnSetting.ON_TRUE)
    public static boolean func_70539_a(EntityFX particle, Tessellator tessellator, float partialTicks, float cosYaw,
        float cosPitch, float sinYaw, float sinSinPitch, float cosSinPitch) {
