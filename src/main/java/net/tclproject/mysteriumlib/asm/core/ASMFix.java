...
public class ASMFix implements Cloneable, Comparable<ASMFix> {
    ...
    public int compareTo(ASMFix fix) {
        if (injectorFactory.priorityReversed && fix.injectorFactory.priorityReversed) { // if both are inserted at the
            ...
            return priority.ordinal() > fix.priority.ordinal() ? -1 : 1; // Since priority is reversed, if our priority
                                                                         // is greater (>) it is actually less
            // (-1)
    ...
    public class Builder extends ASMFix {
         ...
         *
         * <p>
         * Defines the name of the method, into which the fix will be inserted. If fixing a
         ...
         *
         * <p>
         * Those arguments are used to create the descriptor of the target method. In order to
         ...
         *
         * <p>
         * Specifies the name of the fix method. The fix method MUST be static, and there is no check
         ...
         *
         * <p>
         * Adds an argument to the list of arguments of the fix method. In bytecode, the names of the
         * arguments aren't saved. Instead, the use of indexes is needed.
         *
         * <p>
         * For example, in the class EntityLivingBase there is a method:
         ...
         *
         * <p>
         * IMPORTANT: longs and doubles take up two spaces. Theoretically, not only the original
         * aguments can be passed in to the fix method but also local variables, but their indexes will
         * be way harder to calculate.
         *
         * <p>
         * For example, in the class Entity there is a method: setPosition(double x, double y, double
         ...
         *
         * <p>
         * If the target method is static, you don't start counting the indexes from 0, The numbers
         ...
         *
         * <p>
         * Specifies the type that gets returned after the fix method has been called. Call this
         * after setReturnSetting. By default, void is returned.
         *
         * <p>
         * Besides that, if value == EnumReturnType.FIX_RETURN_VALUE, this method changes the return
         ...
         *                                  type of the target method is void (or setTargetMethodReturnType hasn't been
         *                                  called). It
         *                                  doesn't make sense to use the value that the fix method returned, if it
         *                                  returned void (it
         ...
         *
         * <p>
         * Call this after setReturnType(EnumReturnType.PRIMITIVE_CONSTANT). Specifies the primitive,
         ...
         *
         * <p>
         * Call this after setReturnType(EnumReturnType.ANOTHER_METHOD_RETURN_VALUE). Specifies the
