...
public class BuiltinFixes {
  ...
  /**
   * Built-in fix to register CustomClassTransformer after forge's deobfuscation has already
   * happened. This makes it easier to work with minecraft code from it.
   *
   * <p>In order to work with other/non-mc code, use FirstClassTransformer, which is how this fix is
   * applied. It transforms classes earlier on.
   */
  @Fix
