...
public enum EnumReturnSetting {
    ...
    /**
     * return gets called, if the fix method returned true. You can't use this, if the fix method
     * doesn't return a boolean.
     */
    ON_TRUE(true),

    /**
     * return gets called, if the fix method returned null. You can't use this, if the fix method
     * returns a primitive or void.
     */
    ON_NULL(true),
