...
/**
 * A no-operation occlusion cache that doesn't store any data, used to reduce memory usage. This
 * implementation always returns 0 (not checked) for getState, making the system fall back to direct
 * visibility checks.
 */
